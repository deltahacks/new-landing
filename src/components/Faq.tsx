    ...
    return (
      <div className="w-4/5 py-10">
        <Tab.Group defaultIndex={0}>
          <div className="flex-box space-x-1"> 
            <div className="justify-center align-center font-minecraft text-white md:text-3xl gap-x-10">
                ...
                classNames(
                  ...
                  "focus:outline-none",
                  selected
                    ? "bg-[#8e8e8e] h-full shadow-[inset_-5px_-5px_0px_rgb(113,113,113),inset_5px_5px_0px_rgb(177,177,177)]"
                    : "bg-[#606060] h-full shadow-[inset_-5px_-5px_0px_rgba(74,74,74),inset_5px_5px_0px_rgb(169,169,169)]"
                )
              }
                >
                {category}
                ...
                {Object.values(categories).map((info, idx) => (
                    <Tab.Panel key={idx} className="flex-box space-y-5 font-minecraft text-white md:text-3xl"> 
                        {info.map((section, index) => (
                            <Faqsubsection key={index} title={section.title} info={section.info} />
                        ))}
